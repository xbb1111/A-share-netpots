...
describe('large capital metrics', () => {
  ...
  it('caps ETF/product history at 252 days and member history at 120 days', () => {
    ...
    const snapshot = buildLargeCapitalSnapshot({ generatedAt: '2026-12-31T00:00:00.000Z', etfs: [{ code: '510300', series: dates.map((date, index) => ({ date, nav: 1, shares: 100 + index, amount: 1 })) }], institutionDays });
