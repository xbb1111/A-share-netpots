    ...
    <section className="panel industry-workbench" id="industries">
      ...
      {view === 'chain' && chain ? (
        <div className="industry-chain-view">
          ...
          <IndustryCanvasEditor canvas={canvas} onChange={setCanvas} onSave={(next) => { setCanvas(next); saveIndustryCanvases([next]); }} onStock={onOpenPriceTool} onBranch={onOpenIndexTool} />
