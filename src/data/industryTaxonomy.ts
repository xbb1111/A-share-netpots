    ...
    stages: [
      {
        ...
        name: '上游 · 资源与基础材料',
        nodes: [
          { id: 'lithium-resource', name: '锂资源', description: '锂矿、盐湖提锂及锂盐加工。', matchKeywords: ['锂矿', '盐湖提锂', '锂'], boardCodes: ['BK1621'] },
          { id: 'nickel-cobalt', name: '镍钴资源', description: '动力电池所需镍、钴资源及冶炼。', matchKeywords: ['镍', '钴', '小金属'], boardCodes: ['BK1027'] },
          { id: 'rare-earth', name: '稀土永磁', description: '驱动电机所需稀土与永磁材料。', matchKeywords: ['稀土', '磁性材料', '稀土永磁'], boardCodes: ['BK1626'] },
          { id: 'battery-raw-material', name: '电池基础材料', description: '铜箔、铝箔、石墨等电池基础材料。', matchKeywords: ['铜箔', '铝箔', '石墨', '电池材料'], boardCodes: ['BK1302'] },
        ],
      },
      {
        id: 'midstream',
        name: '中游 · 核心制造',
        nodes: [
          { id: 'cathode-anode', name: '正负极材料', description: '正极、负极及前驱体材料。', matchKeywords: ['正极材料', '负极材料', '电池材料'], boardCodes: ['BK1302'] },
          { id: 'separator-electrolyte', name: '隔膜与电解液', description: '锂电隔膜、电解液与添加剂。', matchKeywords: ['隔膜', '电解液', '氟化工'], boardCodes: ['BK1302'] },
          { id: 'power-battery', name: '动力电池', description: '电芯、模组、PACK 与电池回收。', matchKeywords: ['动力电池', '电池', '锂电池', '电池回收'], boardCodes: ['BK1033', 'BK1303'] },
          { id: 'motor-control', name: '电机电控', description: '驱动电机、电控系统与功率器件。', matchKeywords: ['电机', '电控', '功率半导体', 'IGBT'], boardCodes: ['BK1030'] },
          { id: 'thermal-management', name: '热管理', description: '热泵空调、冷却系统及相关零部件。', matchKeywords: ['热管理', '汽车热管理', '制冷'], boardCodes: ['BK1400'] },
          { id: 'auto-parts', name: '汽车零部件', description: '底盘、车身、智能座舱及其他关键零部件。', matchKeywords: ['汽车零部件', '智能座舱', '线控底盘'], boardCodes: ['BK0481', 'BK1528'] },
        ],
      },
      {
        id: 'downstream',
        name: '下游 · 应用与服务',
        nodes: [
          { id: 'complete-vehicle', name: '新能源整车', description: '乘用车、商用车与整车代工。', matchKeywords: ['新能源汽车', '乘用车', '商用车', '汽车整车'], boardCodes: ['BK1211', 'BK1262', 'BK1519'] },
